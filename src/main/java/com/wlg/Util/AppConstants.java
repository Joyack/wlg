...
public class AppConstants {
	...
	public static final String TXN_TYPE = "SysDatadirMgr.feelview.transactionMonitor.txnType";

	/** 数据字典终端管理->终端开通状态的path */
	public static final String TERM_STATUS_PATH = "SysDatadirMgr.javapt.term.status";
	...
	/** 报表菜单rootId **/
	public static final String REPORT_MENU_ROOTID_PATH = "param.javapt.reportManager.reportMenuRootId";
	...
	/** 短信发送方式 */
	public static final String SMS_SETTING_SENDMETHOD_PATH = "SysDatadirMgr.javapt.notice.smsSendType";
	/** 编码 */
	public static final String SMS_SETTING_ENCODING_PATH = "SysDatadirMgr.javapt.common.encoding";
	/** 串口号 */
	...
	public static final String FILEPATH = "param.liquiddata.FILEPATH";
	/**
	 * 项目间分隔符
	 */
	...
	/** LogMonitorService中获取日志管理服务端口号 */
	public static final String Log_SERVER_PORT = "param.feelview.system.logServerPort";

	/** IdataRefreshService日志管理的服务IP */
	public static final String SERVER_IP = "param.feelview.system.serverIP";

	public static final String CHANGE_TYPE = "SysDatadirMgr.javapt.tradeChange.changeType";

	public static final String DEVICE_NAME = "SysDatadirMgr.feelview.TerminalMonitor.AllDeviceParts";
	
	public static final String PARTS_STATUS = "SysDatadirMgr.feelview.TerminalMonitor.PartsStatus";
	public static final String COMPONENT_NAME = "SysDatadirMgr.feelview.TerminalMonitor.AllDeviceParts";

	/** 推送微信端用wsdl */
	public static final String WEIXIN_WSDL = "param.feelview.weixin.WeiXinWSDL";

	public static final String IS_OPENSYNC = "param.feelview.weixin.isOpenSync";

	/** 数据字典管理 布放区域 add by zjing4 */
	public static final String BF_AREA = "SysDatadirMgr.javapt.term.bfArea";
	public static final String YW_TYPE = "SysDatadirMgr.javapt.formManage.ywType";
	public static final String AUDIT_FLOW1 = "SysDatadirMgr.javapt.formManage.auditFlow1";// 银行卡差错处理审批流程
	public static final String ERR_TYPE = "SysDatadirMgr.javapt.formManage.errType";
	public static final String TERM_FLOW = "SysDatadirMgr.javapt.formManage.termApplyFlow";// 互联网机具申请流程
	public static final String TERM_TYPE = "SysDatadirMgr.javapt.term.termType";
	public static final String TERM_KEY_FLOW = "SysDatadirMgr.javapt.formManage.termKeyApplyFlow";// 自助机具密钥申请流程
	public static final String TERM_STOP_FLOW = "SysDatadirMgr.javapt.formManage.termStopApplyFlow";// 自助机具停用流程

	public static final String TEST = "SysDatadirMgr.javapt.term.test";
	/** 短信猫 */
	public static final String SMS_SETTING_MODEM_MANUFACTURER = "SysDatadirMgr.javapt.notice.modemManufacturer";

	public static final String SMS_SETTING_MODEM_MODEL = "SysDatadirMgr.javapt.notice.modemModel";
