...
public class SystemException extends RuntimeException {
	...
	public SystemException(byte errorCode, String nodeCode) {
		super(new StringBuffer().append("异常代号：")
				.append(errorCode)
				.append(",异常描述：")
				.append(errorMsgs.get(errorCode))
				.append(",异常节点：")
	...
	public SystemException(String msg, String nodeCode) {
	...
	public SystemException(byte errorCode, String msg, String nodeCode) {
		super(new StringBuffer().append("异常代号：")
				.append(errorCode)
				.append(",异常描述：")
				.append(msg)
