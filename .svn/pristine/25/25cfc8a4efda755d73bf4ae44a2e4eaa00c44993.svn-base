...
<%--</style>--%>
	...
	<script type="text/javascript">
		function addfile(){
			$('#file').prepend($("#temp").html()+"<br/><br/>");
			$('#file').children("div").eq(1).append("减");
		}
	</script>
</head>
<body>
...
<div id="file">
	<div><input type="file" name="file"  onchange="addfile();"/></div>
</div>

<div id="temp" style="display:none;">
	<div>
		<input type="file" name="file"  onchange="addfile();" value="+"/>
	</div>
</div>
